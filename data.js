...
const POSTERS = [
  {
    ...
    fine: "Nuestro primer modelo todavía es modesto: sin tienda de apps, sin conectividad total. Pero lo reunimos todo en un solo objeto para que vaya con vos a todas partes, todo el tiempo. Y un objeto que reúne todo termina quedándose con todo, rincón por rincón. La frontera entre tu trabajo y tu vida privada se empieza a confundir. Entre lo privado y lo público, también.",
  ...
  },
  {
    ...
    fine: "Cumplimos: en seis meses eran 10.000; en una década, millones. Casi todas piden tus datos, y vos aceptás sin leer. Si la app es gratis, el producto sos vos: no te lo cobramos, te lo extraemos. Y cuanto más instalás, guardás y configurás acá adentro, más caro te sale irte. Eso también lo diseñamos.",
  ...
  },
  {
    ...
    fine: "No están para avisarte. Están para que no puedas soltar el teléfono. Cada punto rojo, cada sonido, cada vibración los calibramos para activar las mismas vías que una máquina tragamonedas. Lo mirás cada tres minutos y creés que es tu decisión: es nuestro diseño. Para no perderte nada, ya no podés perdernos de vista.",
  ...
  },
  {
    ...
    fine: "Diseñamos el «me gusta» para que te genere ansiedad. Esa ansiedad es la que te hace volver. En la próxima década, el 60% de los adolescentes la va a sentir. Lo sabemos, y no vamos a hacer nada para solucionarlo. Te conectamos con todo el mundo, menos con el que tenés al lado.",
  ...
  },
  {
    ...
    headline: "Conocé a Vera.",
    body: "Tu asistente personal. Hablale como a cualquier persona: te entiende, responde tus preguntas y aprende de vos cada día.",
    tagline: "Hablá libremente. Estamos escuchando.",
    fine: "Vera te escucha, no solo cuando le hablás. A eso lo llamamos «mejorar el servicio». Guardamos cada grabación sin fecha de borrado, y a veces la escucha una persona. El micrófono nunca se apaga: lo diseñamos así.",
